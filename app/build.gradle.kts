...
android {
    ...
    defaultConfig {
        ...
        // stability yet -- per the user's explicit choice (2026-07-26). 0.6.0 (2026-07-28): the
        // on-screen menu/button cleanup mentioned as a pre-1.0 open question at 0.5.0 is now
        // largely done (Start Menu/Filters/Settings). Still not 1.0: whether Fire TV is even a
        // 1.0 target remains undecided, and Settings is still missing its D-pad-assignment rows.
        versionCode = 3
        versionName = "0.6.0"
